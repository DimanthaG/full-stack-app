            ...
            <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-3 lg:gap-y-16">
              {features.map((feature, index) => (
                <motion.div
                  ...
                  className="relative pl-16 bg-[#2A3B4C]/20 backdrop-blur-sm p-6 rounded-lg shadow-sm border border-[#4A5B6C]/30"
                >
                  <dt className="text-base font-semibold leading-7 text-white">
                    <div className="absolute left-0 top-0 flex h-10 w-10 items-center justify-center rounded-lg bg-[#4A5B6C] text-white">
                      {feature.icon}
                    </div>
                    {feature.title}
                  </dt>
